...
{ 
                ...
                <Box display={"flex"} justifyContent="center" pos={"relative"} top="-40px">
                        <Avatar border={"2px solid #D7D2D1"} src={Image?.name||Img?.name} size='2xl'/>
                        <Box pos={"absolute"} left="120px" top={"60px"}>
                            <Input onChange={handleImg} type="file" id="upload" hidden/>
                               <label className='label' for="upload"><AiFillCamera/></label>
                        </Box>
                    </Box>
